<#
  ...
  .DESCRIPTION
    Clears (resets) local group policies by deleting registry.pol and associated files. Warning: this script will result in the loss of existing local policies.
  .EXAMPLE
